...
export class ShopService {
  ...
  async purchaseItem(
    ...
    await this.dataSource.transaction(async (entityManager) => {
      ...
      for (let i = 0; i < shopItemIds.length; i++) {
        ...
        const command = `o.usergroup add ${user.steamId} vip`;
        // await this.commandService.saveCommand(userId, 4, command);
  ...
  private async seedItems(): Promise<any> {
    const items = [
      {
        id: '253',
        rs_id: '9991',
        ...
        status: '1',
        variations:
          '[{"variation_id": "6", "variation_name": "6 days", "variation_price": "299", "variation_price_usd": "4"}, {"variation_id": "30", "variation_name": "30 days", "variation_price": "899", "variation_price_usd": "10"}, {"variation_id": "90", "variation_name": "90 days", "variation_price": "2500", "variation_price_usd": "25"}]',
        name_ru: 'VIP',
        name_en: 'VIP',
        description_ru:
          '<p>Позволяет подключаться к серверу без очереди.</p>\r\n\r\n<p>После покупки - переподключитесь к серверу, чтобы зайти без очереди</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>',
        description_en:
          '<p>To pass to the server out of turn</p>\r\n\r\n<p>After purchase, reconnect to the server to jump in line</p>',
        description_de: null,
        description_fr: null,
        description_it: null,
        description_es: null,
        description_uk: null,
        image: 'images/HWOKqdRVWU3M74nOZr0VClk1saYDfjQJAjnSihKN.png',
        sort: '666112',
        created_at: '2024-06-26 13:40:22',
        updated_at: '2024-06-26 13:40:22',
      },
    ];
    try {
      items.map((el) => {
